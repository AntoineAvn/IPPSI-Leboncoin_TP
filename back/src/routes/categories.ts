...
router.get('/categories', ValidateToken.Validation, CategoriesController.getAllCategories)
router.get('/categorie/:id',  ValidateToken.Validation, CategoriesController.getCategory)
